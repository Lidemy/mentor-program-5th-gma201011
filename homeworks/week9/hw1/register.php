...
<main class="board">
  ...
  <span class= "register__title">暱稱：</span>
  <input class = "register__input" type = "text" name = "nickname" />
  </div>
  <div class = "register__column">
  <span class= "register__title">帳號：</span>
  <input class = "register__input" type = "text" name = "username" />
  </div>
  <div class = "register__column">
  <span class= "register__title">密碼：</span>
